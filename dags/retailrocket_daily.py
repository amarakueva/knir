...
with DAG(
    dag_id="retailrocket_daily",
    description="Daily ingestion + ELT for the Retailrocket dataset",
    start_date=datetime(2015, 5, 1),
    schedule="@daily",
    catchup=False,
    max_active_runs=1,
    template_searchpath=["/opt/airflow/sql"],
    tags=["retailrocket", "elt"],
) as dag:
    ...
    start >> prepare_schemas >> ingest_raw

    ingest_raw >> [stg_events, stg_item_properties, stg_category_tree]
